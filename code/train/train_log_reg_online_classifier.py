...
from utils.construct_data import rolling_specific_year
...
if __name__ == '__main__':
    ...
    #parser.add_argument('-length','--len',type = int, default = None)
    parser.add_argument('-len','--length',type = float,help='the length of the year that you want to test', default=0.5)
    ...
    if args.action == 'train':
        ...
        for f in fname_columns:
            ...
            for s, split_date in enumerate(split_dates[:]):
                ...
                ts = copy(time_series.loc[split_date[0]:"2019-12-31"])
